...
Also this process helps to reduce missfire in that exists in the bot, honing in on it's accuracy, because we are adding only samples of nontargets that it throught are targets.
